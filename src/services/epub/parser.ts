...
function parseSpine(packageDoc: Element): EpubSpine {
	...
	const pagesProgressionDirection = spineEl.getAttribute("page-progression-direction") as any;
...
function parseNcx(ncxString: string): EpubNavigationPoint[] {
	...
	const navPoints: EpubNavigationPoint[] = [];

	function parseNavPoint(element: Element, parent?: EpubNavigationPoint[]): EpubNavigationPoint[] {
